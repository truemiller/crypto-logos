export const Logos = [
    ...
    {name: "WXDAI", logo: "/logos/wxdai.png"},
    {name: "HNY", logo: "/logos/hny.png"},
    {name: "AGAVE", logo: "/logos/agave.png"},
    {name: "HAUS", logo: "/logos/haus.png"},
    {name: "STREAMR", logo: "/logos/streamr.png"},
    {name: "RAID", logo: "/logos/raid.png"},
    {name: "PAN", logo: "/logos/pan.png"},
    {name: "FTM", logo: "/logos/ftm.png"},
    {name: "GRT", logo: "/logos/grt.png"},
    {name: "INJ", logo: "/logos/inj.png"},
    {name: "ZRX", logo: "/logos/0x.png"},
    {name: "1INCH", logo: "/logos/1inch.png"},
    {name: "2KEY", logo: "/logos/2key-network.png"},
    {name: "MPG", logo: "/logos/88mpg.png"},
    {name: "ABBC", logo: "/logos/abbc-coin.png"},
    {name: "ACT", logo: "/logos/achain.png"},
    {name: "ADA", logo: "/logos/ada.logo.png"},
    {name: "ADD", logo: "/logos/add-xyz.png"},
    {name: "ELF", logo: "/logos/aelf.png"},
    {name: "AEON", logo: "/logos/aeon.png"},
    {name: "AERON", logo: "/logos/aeron.png"},
    {name: "AE", logo: "/logos/aeternity.png"},
    {name: "AGAVE", logo: "/logos/agave.png"},
    {name: "AGRS", logo: "/logos/agoras-tokens.png"},
    {name: "DLT", logo: "/logos/agrello-delta.png"},
    {name: "AIDOS", logo: "/logos/aidos-kuneen.png"},
    {name: "AION", logo: "/logos/aion.png"},
    {name: "AIRSWAP", logo: "/logos/airswap.png"},
]